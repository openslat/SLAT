...
** LOSS-IM
   ...
   [[file:/tmp/babel-1752Epe/figure-1752PH1.pdf]]
...
** LOSS-IM
   ...
   [[file:/tmp/babel-1752Epe/figure-1752eAi.pdf]]
...
** Non-Collapse
   ...
   #+BEGIN_SRC R
     ...
     lines(neo.loss1.im$mean_x ~ neo.loss1.im$IM)
     lines(neo.loss2.im$mean_x ~ neo.loss2.im$IM)
   ...
   #+BEGIN_SRC R  
     ...
     lines(neo.loss1.im$sd_ln_x ~ neo.loss1.im$IM)
     lines(neo.loss2.im$sd_ln_x ~ neo.loss2.im$IM)
