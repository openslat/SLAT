...
*** Mean
    #+BEGIN_SRC R :colnames yes :results output
      ...
      for (i in 1:nrow(acceleration.cols)) {
          ...
          edp.comparion[i,]$mean.max <- max(paleo.edp.im[[index]]$mean.x - neo.edp.im[[index]]$mean.x)
          edp.comparion[i,]$mean.avg <- mean(abs(paleo.edp.im[[index]]$mean.x - neo.edp.im[[index]]$mean.x))
          edp.comparion[i,]$mean.pct <- 100 * max(abs(paleo.edp.im[[index]]$mean.x - neo.edp.im[[index]]$mean.x)/paleo.edp.im[[index]]$mean.x)

          edp.comparion[i,]$sd.max <- max(paleo.edp.im[[index]]$sd.lnx - neo.edp.im[[index]]$sd.lnx)
          edp.comparion[i,]$sd.avg <- mean(abs(paleo.edp.im[[index]]$sd.lnx - neo.edp.im[[index]]$sd.lnx))
          edp.comparion[i,]$sd.pct <- 100 * max(abs(paleo.edp.im[[index]]$sd.lnx - neo.edp.im[[index]]$sd.lnx)/paleo.edp.im[[index]]$sd.lnx)
      }
      print(edp.comparion, digits=3)
    #+END_SRC

    #+RESULTS:
    #+begin_example
		    Floor mean.max mean.avg mean.pct   sd.max   sd.avg sd.pct
    1  Ground Floor Accel  4.9e-04 8.25e-05   0.0453 0.000762 0.000210  1.211
    2     2nd Story Accel  5.0e-04 1.14e-04   0.0449 0.004579 0.001590  3.984
    3     3rd Floor Accel  4.5e-04 1.97e-04   0.0444 0.004110 0.000710  2.073
    4     4th Floor Accel  4.8e-04 4.31e-05   0.0460 0.005366 0.000628  2.425
    5     5th Floor Accel  4.9e-05 1.37e-05   0.0200 0.003829 0.000601  2.631
    6     6th Floor Accel  5.0e-05 3.51e-05   0.0283 0.001284 0.000688  4.641
    7     7th Floor Accel  4.9e-05 3.49e-05   0.0363 0.002423 0.000529  1.987
    8     8th Floor Accel  5.0e-05 3.45e-05   0.0430 0.003344 0.000390  2.103
    9     9th Floor Accel  5.0e-05 1.50e-05   0.0335 0.001795 0.001071  7.123
    10   10th Floor Accel  5.0e-05 3.46e-05   0.0256 0.001811 0.000672  6.094
    11         Roof Accel  5.0e-05 3.43e-05   0.0291 0.001746 0.000251  0.882
 #+end_example
    ...
    #+CAPTION: mean(Acceleration EDP) vs. IM
    #+ATTR_LaTeX: :width \textwidth*4/4 :placement [h!bt]
...
*** Standard Deviation
    ...
    #+CAPTION: SD(ln(Acceleration EDP)) vs. IM
    #+ATTR_LaTeX: :width \textwidth*4/4 :placement [h!bt]
...
*** Rate
    #+BEGIN_SRC R :results output :colnames yes
      ...
      for (i in 1:nrow(acceleration.cols)) {
          index <- acceleration.cols[i,]$Index
          edp.comparion[i,]$Floor <- acceleration.cols[i,]$Label
          edp.comparion[i,]$mean <- max(paleo.edp.rate[[index]]$lambda - neo.edp.rate[[index]]$lambda)
          edp.comparion[i,]$avg <- mean(abs(paleo.edp.rate[[index]]$lambda - neo.edp.rate[[index]]$lambda))
          edp.comparion[i,]$pct <- 100 * max(abs(paleo.edp.rate[[index]]$lambda - neo.edp.rate[[index]]$lambda)/paleo.edp.rate[[index]]$lambda)
      }
      print(edp.comparion, digits=3)
     #+END_SRC
     ...
     #+begin_example
		     Floor     mean      avg   pct
     1  Ground Floor Accel 0.009499 1.78e-03  8.23
     2     2nd Story Accel 0.004025 7.62e-05 10.96
     3     3rd Floor Accel 0.004132 6.20e-05 13.84
     4     4th Floor Accel 0.004621 7.44e-05 14.25
     5     5th Floor Accel 0.004596 7.41e-05 14.29
     6     6th Floor Accel 0.004326 6.32e-05 12.86
     7     7th Floor Accel 0.000621 4.56e-05 11.55
     8     8th Floor Accel 0.003985 6.77e-05 11.77
     9     9th Floor Accel 0.000529 4.74e-05 10.58
     10   10th Floor Accel 0.000525 4.74e-05  9.36
     11         Roof Accel 0.000905 5.83e-05 13.21
 #+end_example
...
*** Mean
   ...
   #+begin_example
		 Floor mean.max mean.avg mean.pct  sd.max  sd.avg sd.pct
   1   2nd Story Drift    5e-07 2.32e-07  0.00462 0.03367 0.00744   33.5
   2   3rd Floor Drift    5e-07 2.02e-07  0.00377 0.01483 0.00613   29.6
   3   4th Floor Drift    5e-07 1.29e-07  0.00395 0.00874 0.00469   27.0
   4   5th Floor Drift    5e-07 3.16e-07  0.00376 0.00745 0.00487   31.5
   5   6th Floor Drift    5e-07 3.30e-07  0.00322 0.01094 0.00528   33.4
   6   7th Floor Drift    5e-07 3.37e-07  0.00383 0.01914 0.00641   41.5
   7   8th Floor Drift    5e-07 3.13e-07  0.00415 0.03014 0.00848   45.3
   8   9th Floor Drift    5e-07 1.97e-07  0.00458 0.01711 0.00466   11.8
   9  10th Floor Drift    5e-08 3.83e-08  0.00376 0.01461 0.01131   21.6
   10       Roof Drift    5e-08 1.31e-08  0.00327 0.00189 0.00769   26.2
#+end_example
