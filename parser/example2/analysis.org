...
* IM
  ...
  #+NAME: fig:im-rate
  #+RESULTS: im-rate
  [[file:/tmp/babel-1768wy-/figure-17687OT.pdf]]
...
** Loss by Fate (Lines)
    ...
    [[file:/tmp/babel-1782NP6/figure-1782nfm.pdf]]
...
** Loss by Fate (Solid)
    ...
    #+HEADER: :file (org-babel-temp-file "./figure-" ".pdf")
    #+BEGIN_SRC R :session *R-2*
      loss.by.fate.summed <- read.csv("c-results/loss_by_fate", header=TRUE, sep="")
    ...
    [[file:/tmp/babel-1782NP6/figure-1782SlZ.pdf]]
...
* Loss by EDP
   ...
   [[file:/tmp/babel-1768wy-/figure-176855S.pdf]]
...
* Loss by Component Type
   ...
   [[file:/tmp/babel-1768wy-/figure-1768GLN.pdf]]
