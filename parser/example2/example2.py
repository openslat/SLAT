...
for i in range(1, N_EDPS + 1):
    ...
    edp = pyslat.edp("EDP_{:>02}".format(i), IM1,
                     pyslat.probfn.lookup("EDP_FUNC_{}".format(i)))
                                   
    pyslat.MakeRecorder('edpim-{}'.format(i), 'edpim', edp,
    ...
    pyslat.MakeRecorder('edprate-{}'.format(i), 'edprate', edp,
...
COMPONENT_DATA = [[1, "EDP_02", "FRAG_2", "LOSS_2", 20],
                  [2, "EDP_02", "FRAG_2", "LOSS_2", 18],
                  [3, "EDP_04", "FRAG_2", "LOSS_2", 4],
                  [4, "EDP_04", "FRAG_2", "LOSS_2", 18],
                  [5, "EDP_06", "FRAG_2", "LOSS_2", 4],
                  [6, "EDP_06", "FRAG_2", "LOSS_2", 18],
                  [7, "EDP_08", "FRAG_2", "LOSS_2", 4],
                  [8, "EDP_08", "FRAG_2", "LOSS_2", 18],
                  ...
                  [21, "EDP_02", "FRAG_3", "LOSS_3", 16],
                  [22, "EDP_04", "FRAG_3", "LOSS_3", 16],
                  [23, "EDP_06", "FRAG_3", "LOSS_3", 16],
                  [24, "EDP_08", "FRAG_3", "LOSS_3", 16],
                  ...
                  [31, "EDP_02", "FRAG_105", "LOSS_105", 721],
                  [32, "EDP_04", "FRAG_105", "LOSS_105", 721],
                  [33, "EDP_06", "FRAG_105", "LOSS_105", 721],
                  [34, "EDP_08", "FRAG_105", "LOSS_105", 721],
                  ...
                  [41, "EDP_02", "FRAG_107", "LOSS_107", 99],
                  [42, "EDP_04", "FRAG_107", "LOSS_107", 99],
                  [43, "EDP_06", "FRAG_107", "LOSS_107", 99],
                  [44, "EDP_08", "FRAG_107", "LOSS_107", 99],
                  ...
                  [51, "EDP_03", "FRAG_203", "LOSS_203", 693],
                  [52, "EDP_05", "FRAG_203", "LOSS_203", 693],
                  [53, "EDP_07", "FRAG_203", "LOSS_203", 693],
                  [54, "EDP_09", "FRAG_203", "LOSS_203", 693],
                  ...
                  [61, "EDP_03", "FRAG_211", "LOSS_211", 23],
                  [62, "EDP_05", "FRAG_211", "LOSS_211", 23],
                  [63, "EDP_07", "FRAG_211", "LOSS_211", 23],
                  [64, "EDP_09", "FRAG_211", "LOSS_211", 23],
                  ...
                  [71, "EDP_01", "FRAG_208", "LOSS_208", 53],
                  [72, "EDP_03", "FRAG_208", "LOSS_208", 53],
                  [73, "EDP_05", "FRAG_208", "LOSS_208", 53],
                  [74, "EDP_07", "FRAG_208", "LOSS_208", 53],
                  [75, "EDP_09", "FRAG_208", "LOSS_208", 53],
                  ...
                  [81, "EDP_05", "FRAG_209", "LOSS_209", 16],
                  [82, "EDP_11", "FRAG_209", "LOSS_209", 16],
                  [83, "EDP_19", "FRAG_209", "LOSS_209", 16],
                  [84, "EDP_21", "FRAG_205", "LOSS_205", 4],
                  [85, "EDP_01", "FRAG_204", "LOSS_204", 2],
                  [86, "EDP_02", "FRAG_106", "LOSS_106", 721],
                  [87, "EDP_04", "FRAG_106", "LOSS_106", 721],
                  [88, "EDP_06", "FRAG_106", "LOSS_106", 721],
                  [89, "EDP_08", "FRAG_106", "LOSS_106", 721],
                  ...
                  [96, "EDP_02", "FRAG_108", "LOSS_108", 10],
                  [97, "EDP_04", "FRAG_108", "LOSS_108", 10],
                  [98, "EDP_06", "FRAG_108", "LOSS_108", 10],
                  [99, "EDP_08", "FRAG_108", "LOSS_108", 10],
                  ...
                  [106, "EDP_01", "FRAG_214", "LOSS_214", 10],
                  [107, "EDP_03", "FRAG_214", "LOSS_214", 10],
                  [108, "EDP_05", "FRAG_214", "LOSS_214", 10],
                  [109, "EDP_07", "FRAG_214", "LOSS_214", 10],
                  [110, "EDP_09", "FRAG_214", "LOSS_214", 10],
...
for comp in COMPONENT_DATA:
    ...
    pyslat.MakeRecorder("LOSSEDP_{}_REC".format(id), 'lossedp', cg,
                    {'filename': ResultsFile("loss_{}_edp.txt".format(id))},
                    None, 
                    at_values)

    pyslat.MakeRecorder("LOSSIM_{}_REC".format(id), 'lossim', cg,
                    {'filename': ResultsFile("loss_{}_im.txt".format(id))},
                    None, 
                    lossimvalues)

    pyslat.MakeRecorder("DSEDP_{}_REC".format(id), 'dsedp', cg,
                    {'filename': ResultsFile("ds_edp_{}.txt".format(id))},
                    None, 
                    pyslat.frange(0.0, 0.200, 0.01))

    pyslat.MakeRecorder("LOSSRATE_{}_REC".format(id), 'lossrate', cg,
                    {'filename': ResultsFile("loss_rate_{}.txt".format(id))},
                    None, 
                    pyslat.frange(1E-4, 1.2, 4.8E-3))

    pyslat.MakeRecorder("ANNLOSS_{}_REC".format(id), "annloss", cg,
