...
#pragma omp critical
                    ...
                    {
                        struct DATA {
                            int id, edp, frag, count;
                            double cost_adj, delay_adj;
                        };
                        vector <struct DATA> data = 
                            {
                                {1, 2, 2, 20, 1.0, 1.0}, {2, 2, 2, 18, 1.0, 1.0}, {3, 4, 2, 4, 1.0, 1.0}, {4, 4, 2, 18, 1.0, 1.0}, 
                                {5, 6, 2, 4, 1.0, 1.0}, {6, 6, 2, 18, 1.0, 1.0}, {7, 8, 2, 4, 1.0, 1.0}, {8, 8, 2, 18, 1.0, 1.0},
                                {9, 10, 2, 4, 1.0, 1.0}, {10, 10, 2, 18, 1.0, 1.0}, {11, 12, 2, 4, 1.0, 1.0}, {12, 12, 2, 18, 1.0, 1.0},
                                {13, 14, 2, 4, 1.0, 1.0}, {14, 14, 2, 18, 1.0, 1.0}, {15, 16, 2, 4, 1.0, 1.0}, {16, 16, 2, 18, 1.0, 1.0},
                                {17, 18, 2, 4, 1.0, 1.0}, {18, 18, 2, 18, 1.0, 1.0}, {19, 20, 2, 4, 1.0, 1.0}, {20, 20, 2, 18, 1.0, 1.0},
                                {21, 2, 3, 16, 1.0, 1.0}, {22, 4, 3, 16, 1.0, 1.0}, {23, 6, 3, 16, 1.0, 1.0}, {24, 8, 3, 16, 1.0, 1.0}, 
                                {25, 10, 3, 16, 1.0, 1.0}, {26, 12, 3, 16, 1.0, 1.0}, {27, 14, 3, 16, 1.0, 1.0}, 
                                {28, 16, 3, 16, 1.0, 1.0}, {29, 18, 3, 16, 1.0, 1.0}, {30, 20, 3, 16, 1.0, 1.0}, 
                                {31, 2, 105, 721, 1.0, 1.0}, {32, 4, 105, 721, 1.0, 1.0}, {33, 6, 105, 721, 1.0, 1.0},
                                {34, 8, 105, 721, 1.0, 1.0}, {35, 10, 105, 721, 1.0, 1.0}, {36, 12, 105, 721, 1.0, 1.0}, 
                                {37, 14, 105, 721, 1.0, 1.0}, {38, 16, 105, 721, 1.0, 1.0}, {39, 18, 105, 721, 1.0, 1.0}, 
                                {40, 20, 105, 721, 1.0, 1.0}, {41, 2, 107, 99, 1.0, 1.0}, {42, 4, 107, 99, 1.0, 1.0}, 
                                {43, 6, 107, 99, 1.0, 1.0}, {44, 8, 107, 99, 1.0, 1.0}, {45, 10, 107, 99, 1.0, 1.0},
                                {46, 12, 107, 99, 1.0, 1.0}, {47, 14, 107, 99, 1.0, 1.0}, {48, 16, 107, 99, 1.0, 1.0},
                                {49, 18, 107, 99, 1.0, 1.0}, {50, 20, 107, 99, 1.0, 1.0}, {51, 3, 203, 693, 1.0, 1.0},
                                {52, 5, 203, 693, 1.0, 1.0}, {53, 7, 203, 693, 1.0, 1.0}, {54, 9, 203, 693, 1.0, 1.0},
                                {55, 11, 203, 693, 1.0, 1.0}, {56, 13, 203, 693, 1.0, 1.0}, {57, 15, 203, 693, 1.0, 1.0},
                                {58, 17, 203, 693, 1.0, 1.0}, {59, 19, 203, 693, 1.0, 1.0}, {60, 21, 203, 693, 1.0, 1.0},
                                {61, 3, 211, 23, 1.0, 1.0}, {62, 5, 211, 23, 1.0, 1.0}, {63, 7, 211, 23, 1.0, 1.0}, 
                                {64, 9, 211, 23, 1.0, 1.0}, {65, 11, 211, 23, 1.0, 1.0}, {66, 13, 211, 23, 1.0, 1.0}, 
                                {67, 15, 211, 23, 1.0, 1.0}, {68, 17, 211, 23, 1.0, 1.0}, {69, 19, 211, 23, 1.0, 1.0}, 
                                {70, 21, 211, 23, 1.0, 1.0}, {71, 1, 208, 53, 1.0, 1.0}, {72, 3, 208, 53, 1.0, 1.0}, 
                                {73, 5, 208, 53, 1.0, 1.0}, {74, 7, 208, 53, 1.0, 1.0}, {75, 9, 208, 53, 1.0, 1.0}, 
                                {76, 11, 208, 53, 1.0, 1.0}, {77, 13, 208, 53, 1.0, 1.0}, {78, 15, 208, 53, 1.0, 1.0}, 
                                {79, 17, 208, 53, 1.0, 1.0}, {80, 19, 208, 53, 1.0, 1.0}, {81, 5, 209, 16, 1.0, 1.0}, 
                                {82, 11, 209, 16, 1.0, 1.0}, {83, 19, 209, 16, 1.0, 1.0}, {84, 21, 205, 4, 1.0, 1.0}, 
                                {85, 1, 204, 2, 1.0, 1.0}, {86, 2, 106, 721, 1.0, 1.0}, {87, 4, 106, 721, 1.0, 1.0}, 
                                {88, 6, 106, 721, 1.0, 1.0}, {89, 8, 106, 721, 1.0, 1.0}, {90, 10, 106, 721, 1.0, 1.0},
                                {91, 12, 106, 721, 1.0, 1.0}, {92, 14, 106, 721, 1.0, 1.0}, {93, 16, 106, 721, 1.0, 1.0},
                                {94, 18, 106, 721, 1.0, 1.0}, {95, 20, 106, 721, 1.0, 1.0}, {96, 2, 108, 10, 1.0, 1.0}, 
                                {97, 4, 108, 10, 1.0, 1.0}, {98, 6, 108, 10, 1.0, 1.0}, {99, 8, 108, 10, 1.0, 1.0},
                                {100, 10, 108, 10, 1.0, 1.0}, {101, 12, 108, 10, 1.0, 1.0}, {102, 14, 108, 10, 1.0, 1.0},
                                {103, 16, 108, 10, 1.0, 1.0}, {104, 18, 108, 10, 1.0, 1.0}, {105, 20, 108, 10, 1.0, 1.0}, 
                                {106, 1, 214, 10, 1.0, 1.0}, {107, 3, 214, 10, 1.0, 1.0}, {108, 5, 214, 10, 1.0, 1.0},
                                {109, 7, 214, 10, 1.0, 1.0}, {110, 9, 214, 10, 1.0, 1.0}, {111, 11, 214, 10, 1.0, 1.0}, 
                                {112, 13, 214, 10, 1.0, 1.0}, {113, 15, 214, 10, 3.5, 1.0}, {114, 17, 214, 10, 1.0, 2.5},
                                {115, 19, 214, 10, 2.78, 3.14}};
