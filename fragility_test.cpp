...
BOOST_AUTO_TEST_CASE(Fragility_Probability)
{
     ...
     */
    std::vector<double> damage = fragFn.pExceeded(0);
     ...
     * values.
     */
    damage = fragFn.pExceeded(exp(log(0.0062) - 0.4*0.4/2));
    BOOST_CHECK_EQUAL(damage.size(), 4);
    ...
    damage = fragFn.pExceeded(exp(log(0.0230) - 0.4*0.4/2));
    BOOST_CHECK_EQUAL(damage.size(), 4);
    ...
    damage = fragFn.pExceeded(exp(log(0.0440) - 0.4*0.4/2));
    BOOST_CHECK_EQUAL(damage.size(), 4);
    BOOST_CHECK_CLOSE(damage[0], 1.00, 1E-1);
    ...
    damage = fragFn.pExceeded(exp(log(0.0564) - 0.4*0.4/2));
    BOOST_CHECK_EQUAL(damage.size(), 4);
    BOOST_CHECK_CLOSE(damage[0], 1.00, 1E-1);
    ...
    damage = fragFn.pExceeded(exp(log(0.075) - 0.4*0.4/2));
    BOOST_CHECK_EQUAL(damage.size(), 4);
    BOOST_CHECK_CLOSE(damage[0], 1.00, 1E-1);
    ...
    damage = fragFn.pExceeded(exp(log(0.250) - 0.4*0.4/2));
    BOOST_CHECK_EQUAL(damage.size(), 4);
    BOOST_CHECK_CLOSE(damage[0], 1.00, 1E-1);
